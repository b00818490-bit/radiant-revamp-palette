  ...
  return (
    ...
    >
      <div className="mx-auto grid min-h-[86vh] max-w-[1440px] gap-0 lg:grid-cols-12">
        <div className="relative flex flex-col justify-between px-6 py-14 sm:px-10 lg:col-span-3 lg:px-10 lg:py-20">
        ...
        <div className="relative min-h-[520px] lg:col-span-9 lg:min-h-full">
          {settings.image && (
