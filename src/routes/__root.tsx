...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Dermatologist-tested makeup and skincare with pigment that performs. Shop best-sellers, find your shade, and build a routine you'll love." },
      { property: "og:title", content: "Greyon — Clean color. Serious skincare." },
      { property: "og:description", content: "Dermatologist-tested makeup and skincare with pigment that performs. Shop best-sellers, find your shade, and build a routine you'll love." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Greyon — Clean color. Serious skincare." },
      { name: "twitter:description", content: "Dermatologist-tested makeup and skincare with pigment that performs. Shop best-sellers, find your shade, and build a routine you'll love." },
